# Contributing to Byndyusoft.Data.Sessions
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.Data.Sessions code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.Data.Sessions.git
```
